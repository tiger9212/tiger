...
public class WechatController {
    ...
    public String createMenu() throws IOException {
        ...
        MenuItem menuAbout2 = new MenuItem().key("about").type(MenuType.click).name("开发");
        ...
        MenuItem menuAbout3= new MenuItem().key("about").type(MenuType.click).name("`产品`");
        MenuItem menuItem31 = new MenuItem().key("item").type(MenuType.view).name("进入主页stg-一泓").url(this.getUrl(null,null,"18ea2645-bd3f-4ea6-b9f3-453a82f10d16"));
        MenuItem menuItem32 = new MenuItem().key("item").type(MenuType.view).name("进入主页stg-一泓2").url(this.getUrl(null,null,"73a53d67-2e21-4145-aca6-d1f25e7b1931"));
//        MenuItem menuItem6 = new MenuItem().key("item").type(MenuType.view).name("进入主页dev-周易").url("http://open.weixin.qq.com/connect/oauth2/authorize?appid=wx2cc109f2d6113abb&redirect_uri=http%3a%2f%2fdev.outab.com%2fparking%2fapi%2fwechat%2findex%3fuid1%3doEXlSw-GWxRSlWBGk9AMw6595V2o%26uid3%3d63e9d8c7-7a2e-4d93-bb7f-9e48b0263cdb&response_type=code&scope=snsapi_base&state=&connect_redirect=1#wechat_redirect");
...
//        menuAbout.add(menuItem6);
    ...
    public String getUrl(String uid1,String uid2,String uid3){
        ...
        String url = "http://open.weixin.qq.com/connect/oauth2/authorize?appid=wx2cc109f2d6113abb&redirect_uri=http%3a%2f%2fparkingtest.mmall.com%2fapi%2fwechat%2findex%3fuid1%3d"+uid1+"%26uid3%3d"+uid3+"&response_type=code&scope=snsapi_base&state=&connect_redirect=1#wechat_redirect";
        return url;
    }
    @ResponseBody
